...
from dephymnh.utils import arg_error, log
from dephymnh.utils import ERROR, WARNING, INFO, DEBUG
from dephymnh.namelists.Config import Config
from dephymnh.namelists.Case import FC_filename, listCases, Case
...
def create(parser):
  ...
  add_opt_arg("-Z", "Force XALZBOT value", "xalzbot", None)
  ...
  exseg.set_buffer_layer(cas, xalzbot=xalzbot)
