...
from dephymnh.utils import str_time, time_to_secs
from dephymnh.namelists.mesonh import default_preidea, default_exseg
from dephymnh.namelists.mesonh import preidea_LES, exseg_LES
from dephymnh.namelists.mesonh import preidea_CRM, exseg_CRM
from dephymnh.namelists.mesonh import preidea_SCM, exseg_SCM
...
# SI MAX /MIN mettre LSST_DATA = .FALSE
  ...
  def set_buffer_layer(self, cas, xalzbot=None):
    if xalzbot is None:
  ...
  def set_outputs(self, cas, iseg):
    ...
    lseg = cas.begin_seg 
    # convention defined in Case.py setup_outputs
