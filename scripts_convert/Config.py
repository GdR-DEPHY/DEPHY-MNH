...
class Config:
  ...
  def unset_microphysics(self):
    ...
    self.remove("NAM_OUTPUT", "COUT_VAR(1,8)") # RVT
  ...
  def set_adjust_microphysics(self):
    ...
    self.modify("NAM_OUTPUT", "COUT_VAR(1,8)", "'RVT'")
    self.modify("NAM_OUTPUT", "COUT_VAR(1,9)", "'RCT'")
  ...
  def unset_warm_microphysics(self):
    ...
    self.remove("NAM_OUTPUT", "COUT_VAR(1,9)")  # RCT
    self.remove("NAM_OUTPUT", "COUT_VAR(1,10)")  # RRT
    self.remove("NAM_OUTPUT", "COUT_VAR(1,11)") # INPRR
  ...
  def unset_cold_microphysics(self):
    ...
    self.remove("NAM_OUTPUT", "COUT_VAR(1,12)") # RIT
    self.remove("NAM_OUTPUT", "COUT_VAR(1,13)") # RST
    self.remove("NAM_OUTPUT", "COUT_VAR(1,14)") # RGT
  ...
  def set_warm_microphysics(self, moment=1):
    ...
    self.modify("NAM_OUTPUT", "COUT_VAR(1,9)", "'RCT'")
    self.modify("NAM_OUTPUT", "COUT_VAR(1,10)", "'RRT'")
    self.modify("NAM_OUTPUT", "COUT_VAR(1,11)", "'INPRR'")
    self.unset_cold_microphysics()
  ...
  def set_cold_microphysics(self, moment=1):
    ...
    self.modify("NAM_OUTPUT", "COUT_VAR(1,12)", "'RIT'")
    self.modify("NAM_OUTPUT", "COUT_VAR(1,13)", "'RST'")
    self.modify("NAM_OUTPUT", "COUT_VAR(1,14)", "'RGT'")
