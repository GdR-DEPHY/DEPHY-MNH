...
Old_th_bilan =['CORR', 'GMLT', 'DRYG', 'SFR','NECON','DEPI','ADJU','HTURB', 'NETUR', 'DISSH', 'ADV', 'NEGA', 'NEADV', 'AVEF', 'ENDF', 'INIF', 'ASSE', 'VTURB', 'FRC', 'REVA', 'BERFI', 'IMLT', 'RIM', 'WETG', 'CFRZ', 'ACC', 'HIN', 'HON', 'DEPG', 'DEPS']
...
Old_r_bilan =['AVEF', 'ASSE', 'INIF', 'ENDF','FRC','ADV','VTURB','HTURB','DEPI','DEPG','DEPS','REVA','CORR','NEADV','NEGA','NECON','NETUR','HIN','ADJU']

New_r_bilan =['Rv_budget_avg', 'Rv_budget_asse', 'Rv_budget_ini', 'Rv_budget_end','Rv_budget_frc','Rv_budget_adv','Rv_budget_vturb','Rv_budget_hturb','Rv_budget_depi','Rv_budget_depg','Rv_budget_deps','Rv_budget_reva','Rv_budget_corr','Rv_budget_neadv','Rv_budget_nega','Rv_budget_necon','Rv_budget_netur','Rv_budget_hin','Rv_budget_adju']
...
Old_r_bilan =['AVEF', 'ASSE', 'INIF', 'ENDF','FRC','ADV','HTURB','VTURB','DRYG','DEPI','WETG','IMLT','ACCR','CORR','NEADV','NEGA','NECON','NETUR','HON','ADJU','AUTO','SEDI','RIM','CMEL','BERFI']

New_r_bilan =['Rc_budget_avg', 'Rc_budget_asse', 'Rc_budget_ini', 'Rc_budget_end','Rc_budget_frc','Rc_budget_adv','Rc_budget_hturb','Rc_budget_vturb','Rc_budget_dryg','Rc_budget_depi','Rc_budget_wetg','Rc_budget_imlt','Rc_budget_accr','Rc_budget_corr','Rc_budget_neadv','Rc_budget_nega','Rc_budget_necon','Rc_budget_netur','Rc_budget_hon','Rc_budget_adju','Rc_budget_auto','Rc_budget_sedi','Rc_budget_rim','Rc_budget_cmel','Rc_budget_berfi']
