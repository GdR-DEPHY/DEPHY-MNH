...
###############################################################################
Old_u_bilan =['AVEF', 'ASSE', 'INIF', 'ENDF','FRC','ADV','PRES','VTURB','HTURB']

New_u_bilan =['U_budget_avg', 'U_budget_asse', 'U_budget_ini', 'U_budget_end','U_budget_frc','U_budget_adv','U_budget_pres','U_budget_vturb','U_budget_hturb']
...
New_u_bilan =['V_budget_avg', 'V_budget_asse', 'V_budget_ini', 'V_budget_end','V_budget_frc','V_budget_adv','V_budget_pres','V_budget_vturb','V_budget_hturb']
...
Old_th_bilan =['WETH', 'GMLT', 'DRYG', 'HMLT','NECON','DEPI','CEDS','HTURB', 'NETUR', 'DISSH', 'ADV', 'NEGA', 'NEADV', 'AVEF', 'ENDF', 'INIF', 'ASSE', 'VTURB', 'FRC', 'REVA', 'BERFI', 'IMLT', 'RIM', 'WETG', 'CFRZ', 'ACC', 'HIN', 'HINC','HIND','HONC','HONR', 'DEPG', 'DEPS']
New_th_bilan =['TH_budget_weth', 'TH_budget_gmlt', 'TH_budget_dryg', 'TH_budget_hmlt','TH_budget_necon','TH_budget_depi','TH_budget_ceds','TH_budget_hturb','TH_budget_netur','TH_budget_dissh', 'TH_budget_adv', 'TH_budget_nega','TH_budget_neadv','TH_budget_avg','TH_budget_end','TH_budget_ini','TH_budget_asse','TH_budget_vturb', 'TH_budget_frc', 'TH_budget_reva','TH_budget_berfi','TH_budget_imlt','TH_budget_rim','TH_budget_wetg','TH_budget_cfrz', 'TH_budget_acc','TH_budget_hin','TH_budget_hinc','TH_budget_hind','TH_budget_honc','TH_budget_honr','TH_budget_depg','TH_budget_deps']
...
Old_r_bilan =['AVEF', 'ASSE', 'INIF', 'ENDF','FRC','ADV','VTURB','HTURB','DEPI','DEPG','DEPS','REVA','CORR2','NEADV','NEGA','NECON','NETUR','HIN','CEDS']

New_r_bilan =['Rv_budget_avg', 'Rv_budget_asse', 'Rv_budget_ini', 'Rv_budget_end','Rv_budget_frc','Rv_budget_adv','Rv_budget_vturb','Rv_budget_hturb','Rv_budget_depi','Rv_budget_depg','Rv_budget_deps','Rv_budget_reva','Rv_budget_corr2','Rv_budget_neadv','Rv_budget_nega','Rv_budget_necon','Rv_budget_netur','Rv_budget_hin','Rv_budget_ceds']
...
Old_r_bilan =['AVEF', 'ASSE', 'INIF', 'ENDF','FRC','ADV','HTURB','VTURB','DRYG','DEPO','WETG','IMLT','ACCR','CORR2','NEADV','NEGA','NECON','NETUR','HONC','CEDS','AUTO','SEDI','RIM','R2C1','BERFI']

New_r_bilan =['Rc_budget_avg', 'Rc_budget_asse', 'Rc_budget_ini', 'Rc_budget_end','Rc_budget_frc','Rc_budget_adv','Rc_budget_hturb','Rc_budget_vturb','Rc_budget_dryg','Rc_budget_depo','Rc_budget_wetg','Rc_budget_imlt','Rc_budget_accr','Rc_budget_corr2','Rc_budget_neadv','Rc_budget_nega','Rc_budget_necon','Rc_budget_netur','Rc_budget_honc','Rc_budget_ceds','Rc_budget_auto','Rc_budget_sedi','Rc_budget_rim','Rc_budget_r2c1','Rc_budget_berfi']
