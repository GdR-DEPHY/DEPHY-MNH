...
Old_Miscellaneous_Flux_var = ['AVG_PTS', 'BL_H', 'ZCF2TOT','ZCB','LWP','RWP','LWPVAR','ZMAXCF']
    
New_Miscellaneous_Flux_var = ['avg', 'hpbl', 'zcftot','zcb','lwp','rwp','lwpvar','zmaxcf']
...
New_Core_var = ['theta_cor','thetav_cor','thl_cor','qr_cor','pf_cor','u_cor','v_cor',
           'rho_cor','rl_cor','rv_cor','w_cor','rt_cor']
suffix="_cor"
...
New_Tracer_var = ['theta_sam','thetav_sam','thl_sam','rr_sam','pf_sam','u_sam','v_sam',
           'rho_sam','rl_sam','rv_sam','w_sam','rt_sam']
suffix="_sam"
