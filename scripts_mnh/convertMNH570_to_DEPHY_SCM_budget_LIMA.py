...
Dict_attr["TH_budget_deph"] = "Dépôt de grêle"
...
Dict_attr["Rv_budget_ceds"] = "Ajustement de la saturation"
Dict_attr["Rv_budget_deph"] = "Dépôt de grêle"
...
Dict_attr["Rc_budget_cvrc"] = "Changement de la pluie au nuage"
...
Dict_attr["Rc_budget_ceds"] = "Ajustement de la saturation"
...
Dict_attr["Rc_budget_sedi"] = "Transport de chaleur par hydrométéores"
Dict_attr["Rc_budget_r2c1"] = "Changement de la pluie au nuage après sédimentation"
Dict_attr["Rc_budget_auto"] = "Autoconversion en pluie"
...
Old_r_bilan =['AVEF', 'ASSE', 'INIF', 'ENDF','FRC','ADV','DCONV','VTURB','MAFL','DEPI','DEPG','DEPS','REVA','DEPH','HIND','HIN','CEDS']
...
Old_th_bilan =['WETH', 'GMLT', 'DRYG', 'HMLT','NECON','DEPI','CEDS','MAFL', 'NETUR', 'DISSH', 'ADV', 'SEDI', 'NEGA', 'NEADV', 'AVEF', 'ENDF', 'INIF', 'ASSE', 'VTURB', 'DCONV', 'FRC', 'REVA', 'BERFI', 'IMLT', 'DEPH', 'RIM', 'WETG', 'CFRZ', 'ACC', 'HINC', 'HIND', 'HIN', 'HONC', 'DEPG', 'DEPS', 'HONR']
New_th_bilan =['TH_budget_weth', 'TH_budget_gmlt', 'TH_budget_dryg', 'TH_budget_hmlt','TH_budget_necon','TH_budget_depi','TH_budget_ceds','TH_budget_mafl','TH_budget_netur','TH_budget_dissh', 'TH_budget_adv', 'TH_budget_sedi', 'TH_budget_nega','TH_budget_neadv','TH_budget_avg','TH_budget_end','TH_budget_ini','TH_budget_asse','TH_budget_vturb', 'TH_budget_dconv', 'TH_budget_frc', 'TH_budget_reva','TH_budget_berfi','TH_budget_imlt','TH_budget_deph','TH_budget_rim','TH_budget_wetg','TH_budget_cfrz', 'TH_budget_acc', 'TH_budget_hinc', 'TH_budget_hind','TH_budget_hin','TH_budget_honc','TH_budget_depg','TH_budget_deps','TH_budget_honr']
...
Old_rv_bilan =['DEPI', 'CORR2', 'NECON','VTURB', 'DCONV', 'MAFL', 'NETUR', 'FRC', 'ENDF', 'INIF', 'ASSE', 'AVEF', 'ADV', 'DEPG', 'DEPS', 'CEDS', 'DEPH', 'HIND', 'NEGA', 'NEADV', 'HIN', 'REVA']
New_rv_bilan =['Rv_budget_depi', 'Rv_budget_corr2', 'Rv_budget_necon', 'Rv_budget_vturb','Rv_budget_dconv','Rv_budget_mafl','Rv_budget_netur','Rv_budget_frc','Rv_budget_end','Rv_budget_ini', 'Rv_budget_asse', 'Rv_budget_avg', 'Rv_budget_adv','Rv_budget_depg','Rv_budget_deps','Rv_budget_ceds','Rv_budget_deph','Rv_budget_hind','Rv_budget_nega', 'Rv_budget_neadv', 'Rv_budget_hin', 'Rv_budget_reva']

for (old_var_name,new_var_name) in zip(Old_rv_bilan,New_rv_bilan):
  #Gestion des variables inexistantes selon le fichier MNH a convertir
  try:
...
Old_rc_bilan =['CVRC', 'DRYG', 'WETG','WETH', 'NECON', 'CORR2', 'CEDS', 'RIM', 'VTURB', 'DCONV', 'NETUR', 'NEADV', 'ADV', 'ENDF', 'INIF', 'AVEF', 'FRC', 'ASSE', 'NEGA', 'REVA', 'ACCR', 'HONC', 'BERFI', 'IMLT', 'DEPO', 'SEDI', 'R2C1', 'AUTO', 'HINC']
New_rc_bilan =['Rc_budget_cvrc', 'Rc_budget_dryg', 'Rc_budget_wetg', 'Rc_budget_weth','Rc_budget_necon','Rc_budget_corr2','Rc_budget_ceds','Rc_budget_rim','Rc_budget_vturb','Rc_budget_dconv','Rc_budget_netur','Rc_budget_neadv','Rc_budget_adv','Rc_budget_end','Rc_budget_ini',
'Rc_budget_avg','Rc_budget_frc','Rc_budget_asse','Rc_budget_nega','Rc_budget_reva','Rc_budget_accr','Rc_budget_honc','Rc_budget_berfi','Rc_budget_imlt','Rc_budget_depo','Rc_budget_sedi','Rc_budget_r2c1','Rc_budget_auto','Rc_budget_hinc']

for (old_var_name,new_var_name) in zip(Old_rc_bilan,New_rc_bilan):
  #Gestion des variables inexistantes selon le fichier MNH a convertir
  try:
